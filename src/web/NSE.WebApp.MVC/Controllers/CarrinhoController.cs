...
namespace NSE.WebApp.MVC.Controllers
{
    public class CarrinhoController : MainController
    {
        ...
        private void ValidarItemCarrinho(ProdutoViewModel produto, int quantidade)
        {
            ...
            if (quantidade > produto.QuantidadeEstoque) AdicionarErroValidacao($"O produto {produto.Nome} possui apenas {produto.QuantidadeEstoque} unidades no estoque, você selecionou {quantidade}");
        }
    }
}